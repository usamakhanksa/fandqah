...
function wc_pb_woocommerce_number_format(t, e) {
    ...
    n = String(t), t = e ? a : '<span class="woocommerce-Price-currencySymbol">' + a + "</span>";
    return "left" === _ ? n = t + n : "right" === _ ? n += t : "left_space" === _ ? n = t + " " + n : "right_space" === _ && (n = n + " " + t), n = e ? n : '<span class="woocommerce-Price-amount amount">' + n + "</span>"
}
...
function wc_pb_number_format(t) {
    var e = wc_bundle_params.currency_format_num_decimals,
        ...
        s = 3 < (s = n.length) ? s % 3 : 0;
    return a + (s ? n.substring(0, s) + _ : "") + n.substring(s).replace(/(\d{3})(?=\d)/g, "$1" + _) + (e ? i + Math.abs(t - n).toFixed(e).slice(2) : "")
}
...
function wc_pb_format_list(t, e) {
    var i = "",
        ...
        n = e && e.plain_sep;
    if (0 < _)
        for (var s, d = 0, r = 0; r < _; r++) d++, s = a ? t[r] : wc_bundle_params.i18n_string_list_item.replace("%s", t[r]), i = 1 == _ || 1 == d ? s : (d !== _ || n ? wc_bundle_params.i18n_string_list_sep : wc_bundle_params.i18n_string_list_last_sep).replace("%s", i).replace("%v", s);
    return i
}
jQuery.fn.wc_get_bundle_script = function() {
        var t = jQuery(this);
        return !!t.hasClass("bundle_form") && (t = t.data("script_id"), void 0 !== wc_pb_bundle_scripts[t]) && wc_pb_bundle_scripts[t]
    },
    function(b) {
        function o(t) {
            var m = this;
            this.bundle_id = t.bundle_id, this.$bundle_form = t.$bundle_form, this.$bundle_data = t.$bundle_data, this.$bundle_wrap = t.$bundle_data.find(".bundle_wrap"), this.$bundled_items = t.$bundle_form.find(".bundled_product"), this.$bundle_availability = t.$bundle_data.find(".bundle_availability"), this.$bundle_price = t.$bundle_data.find(".bundle_price"), this.$bundle_button = t.$bundle_data.find(".bundle_button"), this.$bundle_error = t.$bundle_data.find(".bundle_error"), this.$bundle_error_content = this.$bundle_error.find("ul.msg"), this.$bundle_quantity = this.$bundle_button.find("input.qty"), this.$nyp = this.$bundle_data.find(".nyp"), this.$addons_totals = this.$bundle_data.find("#product-addons-total"), this.show_addons_totals = !1, this.bundled_items = {}, this.price_data = t.$bundle_data.data("bundle_form_data"), this.$initial_stock_status = !1, this.update_bundle_timer = !1, this.update_price_timer = !1, this.validation_messages = [], this.is_initialized = !1, this.composite_data = t.composite_data, this.dirty_subtotals = !1, this.filters = !1, this.api = {
                ...
                get_bundle_configuration: function() {
                    var _ = {};
                    return 0 !== m.bundled_items.length && (b.each(m.bundled_items, function(t, e) {
                        var i = {
                            title: e.get_title(),
                ...
                this.filters = new i, this.has_addons() ? (1 == this.$addons_totals.data("show-sub-total") || this.is_composited() && this.composite_data.component.show_addons_totals) && (this.$addons_totals.data("show-sub-total", 0), this.$bundle_price.after(this.$addons_totals), this.show_addons_totals = !0, m.$bundle_data.trigger("woocommerce-product-addons-update")) : this.$addons_totals = !1, 0 < this.$bundle_wrap.find("p.stock").length && (this.$initial_stock_status = this.$bundle_wrap.find("p.stock").clone()), this.price_data ? this.$bundle_data.data("bundle_price_data") || this.$bundle_data.data("bundle_price_data", this.price_data) : this.price_data = t.$bundle_data.data("bundle_price_data"), this.price_data.suffix_exists = "" !== wc_bundle_params.price_display_suffix, this.price_data.suffix = "" !== wc_bundle_params.price_display_suffix ? ' <small class="woocommerce-price-suffix">' + wc_bundle_params.price_display_suffix + "</small>" : "", this.price_data.suffix_contains_price_incl = -1 < wc_bundle_params.price_display_suffix.indexOf("{price_including_tax}"), this.price_data.suffix_contains_price_excl = -1 < wc_bundle_params.price_display_suffix.indexOf("{price_excluding_tax}"), this.$bundle_button.find('input[name*="bundle_variation"], input[name*="bundle_attribute"]').remove(), this.bind_event_handlers(), this.viewport_resized(), this.init_bundled_items(), this.is_composited() && this.init_composite(), "yes" === wc_bundle_params.is_pao_installed && void 0 !== window.WC_PAO && this.match_bundled_items_addons_forms(), this.$bundle_data.trigger("woocommerce-product-bundle-initializing", [this]), b.each(this.bundled_items, function(t, e) {
                    e.init_scripts()
                }), this.update_bundle_task(), this.is_initialized = !0, this.$bundle_form.addClass("initialized"), this.$bundle_data.trigger("woocommerce-product-bundle-initialized", [this])
                ...
                (void 0 !== this.composite_data.component.component_selection_model.selected_product ? parseInt(this.composite_data.component.component_selection_model.selected_product, 10) === parseInt(this.bundle_id, 10) : parseInt(this.composite_data.component.component_selection_model.get("selected_product"), 10) === parseInt(this.bundle_id, 10)) ? this.add_composite_hooks(): this.remove_composite_hooks()
            }, this.add_composite_hooks = function() {
                this.composite_data.composite.filters.add_filter("component_is_valid", this.cp_component_is_valid_filter, 10, this), this.composite_data.composite.filters.add_filter("component_selection_formatted_title", this.cp_component_selection_formatted_title_filter, 10, this), this.composite_data.composite.filters.add_filter("component_selection_meta", this.cp_component_selection_meta_filter, 10, this), this.composite_data.composite.filters.add_filter("component_totals", this.cp_component_totals_filter, 10, this), this.composite_data.composite.filters.add_filter("component_configuration", this.cp_component_configuration_filter, 10, this), this.composite_data.composite.actions.add_action("validate_step", this.cp_validation_messages_action, 10, this)
            }, this.remove_composite_hooks = function() {
                this.composite_data.composite.filters.remove_filter("component_is_valid", this.cp_component_is_valid_filter), this.composite_data.composite.filters.remove_filter("component_selection_formatted_title", this.cp_component_selection_formatted_title_filter), this.composite_data.composite.filters.remove_filter("component_selection_meta", this.cp_component_selection_meta_filter), this.composite_data.composite.filters.remove_filter("component_totals", this.cp_component_totals_filter), this.composite_data.composite.filters.remove_filter("component_configuration", this.cp_component_configuration_filter), this.composite_data.composite.actions.remove_action("component_scripts_initialized_" + this.composite_data.component.step_id, this.component_scripts_initialized_action), this.composite_data.composite.actions.remove_action("validate_step", this.cp_validation_messages_action)
                ...
                var _, a;
                return e.step_id === this.composite_data.component.step_id && parseInt(e.get_selected_product(), 10) === parseInt(m.bundle_id, 10) ? (_ = b.extend(!0, {}, m.price_data), a = m.has_addons() ? m.get_addons_raw_price() : 0, i = void 0 === i ? e.get_selected_quantity() : i, 0 < a && (_.base_price = Number(_.base_price) + Number(a)), _ = m.calculate_subtotals(!1, _, i), (_ = m.calculate_totals(_)).totals) : t
            }, this.cp_component_selection_formatted_title_filter = function(t, e, i, _, a) {
                var n;
                return a.step_id === this.composite_data.component.step_id && parseInt(a.get_selected_product(), 10) === parseInt(this.bundle_id, 10) && (n = 0, b.each(this.bundled_items, function(t, e) {
                    0 < e.$bundled_item_cart.data("quantity") && n++
                }), this.group_mode_supports("component_multiselect")) && (0 === n ? t = wc_composite_params.i18n_no_selection : (a = this.cp_get_formatted_contents(a)) && (t = a)), t
            }, this.cp_component_selection_meta_filter = function(t, e) {
                var i;
                return e.step_id === this.composite_data.component.step_id && parseInt(e.get_selected_product(), 10) === parseInt(this.bundle_id, 10) && (i = 0, b.each(this.bundled_items, function(t, e) {
                    0 < e.$bundled_item_cart.data("quantity") && i++
                }), 0 !== i) && !1 === this.group_mode_supports("component_multiselect") && "" !== (e = this.cp_get_formatted_contents(e)) && t.push({
                    meta_key: wc_bundle_params.i18n_contents,
                    meta_value: e
                }), t
                ...
                return b.each(this.bundled_items, function(t, e) {
                    if (e.$self.hasClass("bundled_item_hidden")) return !0;
                    var i, _, a, n;
                    0 < e.$bundled_item_cart.data("quantity") && (i = 0 < (i = e.$bundled_item_image.find("img").first()).length && i.get(0).outerHTML, a = parseInt(e.$bundled_item_cart.data("quantity") * d, 10), _ = wc_cp_get_variation_data(e.$bundled_item_cart.find(".variations")), e = e.$bundled_item_cart.data("title"), a = 1 < a ? "<strong>" + wc_composite_params.i18n_qty_string.replace("%s", a) + "</strong>" : "", n = "", 0 < _.length && (b.each(_, function(t, e) {
                        n = n + '<span class="bundled_meta_element"><span class="bundled_meta_key">' + e.meta_key + ':</span> <span class="bundled_meta_value">' + e.meta_value + "</span>", t !== _.length - 1 && (n += '<span class="bundled_meta_value_sep">, </span>'), n += "</span>"
                    }), e = wc_bundle_params.i18n_title_meta_string.replace("%t", e).replace("%m", '<span class="content_bundled_product_meta">' + n + "</span>")), e = wc_composite_params.i18n_title_string.replace("%t", e).replace("%q", a).replace("%p", ""), s.push({
                        title: e,
                        image: i
                    }))
                }), 0 < s.length && (i += '<span class="content_bundled_product_details_wrapper">', b.each(s, function(t, e) {
                    i = i + '<span class="content_bundled_product_details">' + (e.image ? '<span class="content_bundled_product_image">' + e.image + "</span>" : "") + '<span class="content_bundled_product_title">' + e.title + "</span></span>"
                }), i += "</span>"), i
            }, this.cp_component_is_valid_filter = function(t, e, i) {
                return t = i.step_id === this.composite_data.component.step_id && parseInt(i.get_selected_product(e), 10) === parseInt(this.bundle_id, 10) && 0 < i.get_selected_quantity() && i.is_visible() ? this.passes_validation() : t
            }, this.cp_validation_messages_action = function(i, t) {
                i.step_id === this.composite_data.component.step_id && !1 === t && parseInt(i.get_selected_product(), 10) === parseInt(this.bundle_id, 10) && (t = this.get_validation_messages(), b.each(t, function(t, e) {
                ...
                b(window).on("resize", function() {
                    clearTimeout(m.viewport_resize_timer), m.viewport_resize_timer = setTimeout(function() {
                        m.viewport_resized()
                    }, 50)
                }), m.has_addons() && m.$bundle_data.on("updated_addons", m.updated_addons_handler), m.is_composited() && m.$bundle_quantity.on("input change", function() {
                    m.$bundle_data.trigger("woocommerce-product-bundle-update")
                }), this.$bundle_data.on("woocommerce-nyp-updated-item", function(t) {
                    m.$nyp.is(":visible") && (m.price_data.base_regular_price = m.$nyp.data("price"), m.price_data.base_price = m.price_data.base_regular_price, m.is_initialized) && (m.dirty_subtotals = !0, m.update_totals()), t.stopPropagation()
                }).on("woocommerce-product-bundle-validation-status-changed", function(t, e) {
                    e.updated_totals()
                }).on("click", ".bundle_add_to_cart_button", function(t) {
                    b(this).hasClass("disabled") && (t.preventDefault(), window.alert(wc_bundle_params.i18n_validation_alert))
                ...
                n.$self.on("input change", "input.bundled_qty", function(t) {
                    ...
                    n.set_variation_id(""), m.price_data.quantities_available[n.bundled_item_id] = "", m.price_data.is_in_stock[n.bundled_item_id] = "", m.price_data.backorders_allowed[n.bundled_item_id] = "", m.price_data.backorders_require_notification[n.bundled_item_id] = "", n.is_selected() && n.maybe_add_wc_core_gallery_class(), n.$attribute_select && n.$attribute_select.each(function() {
                ...
                }), n.has_addons() && n.$bundled_item_cart.on("updated_addons", function(t) {
                    n.$addons_totals.html(n.addons_totals_html), m.$bundle_data.trigger("woocommerce-product-bundle-update", [n]), t.stopPropagation()
                }), n.is_nyp() && n.$bundled_item_cart.on("woocommerce-nyp-updated-item", function(t) {
                    var e;
                    n.$nyp.is(":visible") && (e = n.$nyp.data("price"), m.price_data.prices[n.bundled_item_id] = e, m.price_data.regular_prices[n.bundled_item_id] = e, m.$bundle_data.trigger("woocommerce-product-bundle-update", [n])), t.stopPropagation()
                })
                ...
                var i = [],
                    ...
                    a = [],
                    n = !0;
                return b.each(m.bundled_items, function(t, e) {
                    if (e.has_insufficient_stock() && (i.push(e.get_title(!0)), !e.is_visible() || !e.get_title(!0))) return _ = !1
                }), 0 < i.length ? _ ? wc_bundle_params.i18n_insufficient_stock_list.replace("%s", wc_pb_format_list(i, {
                    plain: !0,
                    plain_sep: !0
                })) : wc_bundle_params.i18n_insufficient_stock_status : !m.$bundle_form.hasClass("bundle_out_of_stock") && !m.$bundle_form.hasClass("bundle_insufficient_stock") && (b.each(m.bundled_items, function(t, e) {
                    if (e.is_backordered() && (a.push(e.get_title(!0)), !e.is_visible() || !e.get_title(!0))) return n = !1
                }), 0 < a.length ? n ? wc_bundle_params.i18n_on_backorder_list.replace("%s", wc_pb_format_list(a, {
                    plain: !0,
                    plain_sep: !0
                })) : wc_bundle_params.i18n_on_backorder_status : "")
            }, this.update_bundle = function(t) {
                clearTimeout(m.update_bundle_timer), m.update_bundle_timer = setTimeout(function() {
                ...
                return a && i && (e.price_incl_tax = wc_pb_number_round(e.price * a), e.price_excl_tax = wc_pb_number_round(e.price * i), "incl" === wc_bundle_params.tax_display_shop ? (e.price = e.price_incl_tax, e.regular_price = wc_pb_number_round(e.regular_price * a)) : (e.price = e.price_excl_tax, e.regular_price = wc_pb_number_round(e.regular_price * i))), e
            }, this.calculate_subtotals = function(l, t, u) {
                var e, i, _, p = void 0 === t ? m.price_data : t;
                if (u = void 0 === u ? 1 : parseInt(u, 10), !1 === (l = void 0 !== l && l) && (e = Number(p.base_price), i = Number(p.base_regular_price), _ = p.base_price_tax, p.base_price_totals = this.get_taxed_totals(e, i, _, u)), b.each(m.bundled_items, function(t, e) {
                        ...
                        var i = e.is_sold_individually() && 0 < p.quantities[e.bundled_item_id] ? 1 : p.quantities[e.bundled_item_id] * u,
                            ...
                            n = e.is_subscription() ? p.regular_prices[e.bundled_item_id] : p.regular_prices[e.bundled_item_id] + p.regular_addons_prices[e.bundled_item_id],
                            s = e.is_subscription() ? p.prices[e.bundled_item_id] : p.prices[e.bundled_item_id] + p.addons_prices[e.bundled_item_id],
                            ...
                            _ = ("yes" === wc_bundle_params.calc_taxes ? 0 < _ && 0 < i && ((0 < s || 0 < n) && (o = m.get_taxed_totals(s, n, a, i)), 0 < r || 0 < d) && (c = m.get_taxed_totals(r, d, a, i)) : (o.price = i * s, o.regular_price = i * n, o.price_incl_tax = i * s, o.price_excl_tax = i * s, c.price = i * r, c.regular_price = i * d, c.price_incl_tax = i * r, c.price_excl_tax = i * r), o = m.filters.apply_filters("bundled_item_totals", [o, e, u]), c = m.filters.apply_filters("bundled_item_recurring_totals", [c, e, u]), !1);
                        m.totals_changed(p["bundled_item_" + e.bundled_item_id + "_totals"], o) && (m.dirty_subtotals = _ = !0, p["bundled_item_" + e.bundled_item_id + "_totals"] = o), m.totals_changed(p["bundled_item_" + e.bundled_item_id + "_recurring_totals"], c) && (m.dirty_subtotals = _ = !0, p["bundled_item_" + e.bundled_item_id + "_recurring_totals"] = c), _ && m.$bundle_data.trigger("woocommerce-bundled-item-totals-changed", [e])
                    }), void 0 !== t) return p
            }, this.calculate_totals = function(t) {
                void 0 === t && m.$bundle_data.trigger("woocommerce-product-bundle-calculate-totals", [m]);
                var e, a = void 0 === t ? m.price_data : t,
                    i = !1,
                    _ = {
                    ...
                    n = (b.each(m.bundled_items, function(t, e) {
                        if (e.is_unavailable()) return !0;
                        e = a["bundled_item_" + e.bundled_item_id + "_totals"];
                        void 0 !== e && (_.price += wc_pb_number_round(e.price), _.regular_price += wc_pb_number_round(e.regular_price), _.price_incl_tax += wc_pb_number_round(e.price_incl_tax), _.price_excl_tax += wc_pb_number_round(e.price_excl_tax))
                    }), m.get_bundled_subscriptions()),
                    s = {};
                return n && b.each(n, function(t, e) {
                    var i, _ = e.bundled_item_id;
                    return 0 === a.quantities[_] || "variable-subscription" === e.get_product_type() && "" === e.get_variation_id() || (e = a.recurring_keys[_], i = a["bundled_item_" + _ + "_recurring_totals"], void(void 0 === s[e] ? s[e] = {
                        html: a.recurring_html[_],
                        price: i.price,
                        regular_price: i.regular_price,
                        price_incl_tax: i.price_incl_tax,
                        price_excl_tax: i.price_excl_tax
                    } : (s[e].price += i.price, s[e].regular_price += i.regular_price, s[e].price_incl_tax += i.price_incl_tax, s[e].price_excl_tax += i.price_excl_tax)))
                }), e = _, _ = m.filters.apply_filters("bundle_totals", [_, a, m]), !(i = !(i = m.totals_changed(a.totals, _)) && n && JSON.stringify(a.recurring_totals) !== JSON.stringify(s) ? !0 : i) && !1 !== m.is_initialized || (a.subtotals = e, a.totals = _, a.recurring_totals = s, void 0 !== t) || this.updated_totals(), a
            }, this.updated_totals = function() {
                clearTimeout(m.update_price_timer), m.update_price_timer = setTimeout(function() {
                    m.updated_totals_task()
                }, 5)
            }, this.get_price_html = function(t) {
                var t = void 0 === t ? m.price_data : t,
                    e = !1,
                    i = m.is_composited() ? m.composite_data.component.get_selected_quantity() : 1,
                    _ = "p",
                    a = (m.has_addons() && (a = (t = b.extend(e = !0, {}, t)).addons_price || m.get_addons_raw_price(), n = t.addons_regular_price || a, 0 < a && (t.base_price = Number(t.base_price) + Number(a)), 0 < n) && (t.base_regular_price = Number(t.base_regular_price) + Number(n)), (e = m.is_composited() && (_ = "span", "yes" === t.composited_totals_incl_qty) ? !0 : e) && (t = m.calculate_subtotals(!1, t, i), t = m.calculate_totals(t)), ""),
                    n = "yes" === t.show_total_string && wc_bundle_params.i18n_total ? '<span class="total">' + wc_bundle_params.i18n_total + "</span>" : "",
                    e = 0 === t.totals.price && "yes" === t.show_free_string ? wc_bundle_params.i18n_free : wc_pb_price_format(t.totals.price),
                    i = wc_pb_price_format(t.totals.regular_price),
                    s = m.get_formatted_price_suffix(t),
                    i = (t.totals.regular_price > t.totals.price && (e = wc_bundle_params.i18n_strikeout_price_string.replace("%f", i).replace("%t", e)), a = wc_bundle_params.i18n_price_format.replace("%t", n).replace("%p", e).replace("%s", s), m.get_recurring_price_html());
                return a = i ? 0 < t.totals.regular_price ? "<" + _ + ' class="price">' + t.price_string_recurring_up_front.replace("%s", a).replace("%r", i) + "</" + _ + ">" : "<" + _ + ' class="price">' + t.price_string_recurring.replace("%r", i) + "</" + _ + ">" : "<" + _ + ' class="price">' + a + "</" + _ + ">"
            }, this.get_recurring_price_html = function(t) {
                var n = void 0 === t ? m.price_data : t,
                    s = "";
                if (m.get_bundled_subscriptions()) {
                    var e, d = 0 < n.totals.regular_price,
                        r = [];
                    for (e in n.recurring_totals) n.recurring_totals.hasOwnProperty(e) && r.push(n.recurring_totals[e]);
                    b.each(r, function(t, e) {
                        var i = 0 == e.price ? wc_bundle_params.i18n_free : wc_pb_price_format(e.price),
                            _ = wc_pb_price_format(e.regular_price),
                            a = m.get_formatted_price_suffix(n, {
                                price_incl_tax: e.price_incl_tax,
                                price_excl_tax: e.price_excl_tax
                            });
                        e.regular_price > e.price && (i = wc_bundle_params.i18n_strikeout_price_string.replace("%f", _).replace("%t", i)), _ = wc_bundle_params.i18n_price_format.replace("%t", "").replace("%p", i).replace("%s", a), _ = '<span class="bundled_sub_price_html">' + e.html.replace("%s", _) + "</span>", s = t === r.length - 1 || 0 === t && !d ? 0 < t || d ? wc_bundle_params.i18n_recurring_price_join_last.replace("%r", s).replace("%c", _) : _ : wc_bundle_params.i18n_recurring_price_join.replace("%r", s).replace("%c", _)
                    })
                }
                return s
            }, this.show_price_html = function() {
                var i;
                return !!m.showing_price_html || (i = wc_pb_number_round(m.price_data.totals.price) !== wc_pb_number_round(m.price_data.raw_bundle_price_min) || m.price_data.raw_bundle_price_min !== m.price_data.raw_bundle_price_max, m.get_bundled_subscriptions() && b.each(m.bundled_items, function(t, e) {
                    if (0 < m.price_data.recurring_prices[e.bundled_item_id] && 0 < m.price_data.quantities[e.bundled_item_id] && (e.is_subscription("variable") || e.is_optional() || e.$self.find(".quantity input[type!=hidden]").length)) return !(i = !0)
                }), i && b.each(m.bundled_items, function(t, e) {
                ...
                }), m.is_composited() && (i || m.composite_data.composite.api.is_component_priced_individually(this.composite_data.component.step_id) && (i = !0), !i || !1 !== this.composite_data.component.is_selected_product_price_visible() && !1 !== m.composite_data.composite.api.is_component_priced_individually(this.composite_data.component.step_id) || (i = !1)), i && (m.showing_price_html = !0), i)
            }, this.updated_totals_task = function() {
                var t = m.show_price_html();
                (m.passes_validation() || "no" === m.price_data.hide_total_on_validation_fail) && t ? (t = m.get_price_html(), t = m.filters.apply_filters("bundle_total_price_html", [t, m]), m.$bundle_price.html(t), m.$bundle_price.slideDown(200)) : m.$bundle_price.slideUp(200), m.$bundle_data.trigger("woocommerce-product-bundle-updated-totals", [m])
                ...
                var t = void 0 !== t ? t : this,
                    i = !1;
                return t.has_addons && (t = t.$addons_totals.data("price_data"), b.each(t, function(t, e) {
                ...
                var t = void 0 === t ? m.price_data : t,
                    i = "";
                return e = void 0 === e ? t.totals : e, i = t.suffix_exists && (i = t.suffix, t.suffix_contains_price_incl && (i = i.replace("{price_including_tax}", wc_pb_price_format(e.price_incl_tax))), t.suffix_contains_price_excl) ? i.replace("{price_excluding_tax}", wc_pb_price_format(e.price_excl_tax)) : i
        ...
        function e(n, t, e) {
            this.initialize = function() {
            ...
            }, this.set_variation_id = function(t) {
                this.variation_id = t.toString()
                ...
                return !(!this.is_selected() || 0 === this.get_selected_quantity() || this.is_variable_product_type() && "" === this.get_variation_id() || this.is_in_stock() && !("" !== this.get_available_quantity() && this.get_selected_quantity() > this.get_available_quantity()) || this.backorders_allowed())
            }, this.is_backordered = function() {
                return !(!this.is_selected() || 0 === this.get_selected_quantity() || this.is_variable_product_type() && "" === this.get_variation_id() || !(("" === this.get_available_quantity() || this.get_selected_quantity() > this.get_available_quantity()) && this.backorders_allowed() && this.backorders_require_notification()))
                ...
                "undefined" != typeof PhotoSwipe && "yes" === wc_bundle_params.photoswipe_enabled && this.init_photoswipe(), this.$self.find(".bundled_product_optional_checkbox input").trigger("change"), this.$self.find("input.bundled_qty").trigger("change"), this.is_variable_product_type() && !this.$bundled_item_cart.hasClass("variations_form") && (this.$reset_bundled_variations = this.$bundled_item_cart.find(".reset_bundled_variations"), 0 === this.$reset_bundled_variations.length && (this.$reset_bundled_variations = !1), this.$bundled_item_cart.addClass("variations_form").wc_variation_form(), this.$attribute_select = this.$bundled_item_cart.find(".variations .attribute_options select"), this.$attribute_select_config = this.$attribute_select.filter(function() {
                    return !1 === b(this).parent().hasClass("bundled_variation_attribute_options_wrapper")
                }), 0 < this.$attribute_select.length) && this.$attribute_select.first().trigger("change"), this.$self.find("div").stop(!0, !0), this.update_selection_title()
            }, this.init_photoswipe = function() {
                b.fn.wc_product_gallery ? this.$bundled_item_image.wc_product_gallery({
                    zoom_enabled: "yes" === wc_bundle_params.zoom_enabled,
                ...
                var t = !1,
                    e = this.addons_form;
                return e && (e = e.validation.getValidationState(), b.each(e, function() {
                    if (!this.validation && "required" === this.reason) return !(t = !0)
                })), t
                ...
                n.price_data.addons_prices[this.bundled_item_id] === t && n.price_data.regular_addons_prices[this.bundled_item_id] === e || (n.price_data.addons_prices[this.bundled_item_id] = t, n.price_data.regular_addons_prices[this.bundled_item_id] = e)
            }, this.render_addons_totals = function() {
                var t = this;
                clearTimeout(this.render_addons_totals_timer), this.render_addons_totals_timer = setTimeout(function() {
                    t.render_addons_totals_task()
                }, 10)
            }, this.render_addons_totals_task = function() {
                var t, e, i;
                this.has_addons && (i = n.price_data.addons_prices[this.bundled_item_id], this.show_addons_totals) && ((!this.is_variable_product_type() || "" !== this.get_variation_id()) && (e = this.get_quantity(), t = n.price_data.prices_tax[this.bundled_item_id], 0 < n.get_taxed_totals(i, i, t, e).price) ? (i = Number(n.price_data.prices[this.bundled_item_id]) + Number(i), t = wc_pb_price_format((i = n.get_taxed_totals(i, i, t, e)).price), e = n.get_formatted_price_suffix(n.price_data, i), i = '<span class="price"><span class="subtotal">' + wc_bundle_params.i18n_subtotal + "</span>" + t + e + "</span>", this.addons_totals_html = i, this.$addons_totals.html(i).slideDown(200)) : this.$addons_totals.slideUp(200))
                ...
                return 0 < this.$attribute_select_config.length
            }, this.reset_variation_image = function() {
                return n.filters.apply_filters("bundled_item_reset_variation_image", [this.is_optional() && !this.is_selected() && this.has_configurable_attributes(), this])
            }, this.is_nyp = function() {
                return this.nyp
            }, this.is_nyp_valid = function() {
                var t, e = !0;
                return e = b.fn.wc_nyp_get_script_object && (t = this.$nyp.wc_nyp_get_script_object()) && !1 === t.isValid() ? !1 : e
                ...
                n = {
                    add_filter: function(t, e, i, _) {
                        e = {
                            ...
                            priority: i,
                            context: _
                        }, i = (i = s[t]) ? (i.push(e), this.sort_filters(i)) : [e];
                        s[t] = i
                    },
                    remove_filter: function(t, e, i) {
                        ...
                        if (s[t])
                            if (e)
                                if (_ = s[t], i)
                                    for (n = _.length; n--;)(a = _[n]).callback === e && a.context === i && _.splice(n, 1);
                                else
                                    for (n = _.length; n--;) _[n].callback === e && _.splice(n, 1);
                        else s[t] = []
                    },
                    sort_filters: function(t) {
                        for (var e, i, _, a = 1, n = t.length; a < n; a++) {
                            for (e = t[a], i = a;
                                (_ = t[i - 1]) && _.priority > e.priority;) t[i] = t[i - 1], --i;
                            t[i] = e
                        }
                        return t
                    },
        ...
        jQuery(function(r) {
            r("body").on("quick-view-displayed", function() {
                ...
                var i, _, a = t.closest(".bundle_form"),
                    n = a.closest(".composite_form"),
                    s = !1,
                    d = e;
                0 < n.length && 0 < (i = a.closest(".component").data("item_id")) && r.fn.wc_get_composite_script && !1 !== (n = n.wc_get_composite_script()) && !1 !== (_ = n.api.get_step(i)) && (s = {
                    composite: n,
                    component: _
                }, d = i), void 0 !== wc_pb_bundle_scripts[d] && wc_pb_bundle_scripts[d].shutdown(), wc_pb_bundle_scripts[d] = new o({
                    $bundle_form: a,
                    $bundle_data: t,
                    bundle_id: e,
                    composite_data: s
                }), a.data("script_id", d), wc_pb_bundle_scripts[d].initialize()
