! function(_) {
    "use strict";
    var e, t, n, i, r = tinymce.util.Tools.resolve("tinymce.ThemeManager"),
            ...
            var i, o = function() {
                ...
                n = function(e, t) {
                    ...
                    if (!x.removed) {
                        ...
                        var g, p, v, b = W.getUiContainerDelta(s).getOr({
                            x: 0,
                            y: 0
                        });
                        ...
                        x.inline || (o.w = x.getDoc().documentElement.offsetWidth), x.selection.controlSelection.isResizable(e.element) && r.w < 25 && (r = C.inflate(r, 0, 8)), n = C.findBestRelativePosition(i, r, o, l), r = C.clamp(r, o), n ? (a = C.relativePosition(i, r, n), z(s, I(u, a.x, a.y, r, o, i))) : (o.h += i.h, (r = C.intersect(o, r)) ? (n = C.findBestRelativePosition(i, r, o, ["bc-tc", "bl-tl", "br-tr"])) ? (a = C.relativePosition(i, r, n), z(s, I(u, a.x, a.y, r, o, i))) : z(s, I(u, r.x, r.y, r, o, i)) : s.hide()), g = s, v = function(e, t) {
                            return e === t
    ...
    Ae = {
        ...
        filter: function(t) {
            var e, n, i, r, o = [];
            for ("string" == typeof t ? (t = new Ie(t), r = function(e) {
                    return t.match(e)
    ...
    var Xe, je, Je = Se.extend({
        ...
        tt = {
            ...
            fire: function(e, t, n) {
                if ((t = t || {}).control || (t.control = this), t = nt(this).fire(e, t), !1 !== n && this.parent)
    ...
    function ct(e, h) {
        ...
        t = function(e) {
            ...
            ut(e), e.preventDefault(), g = e.button, c = w, b = e.screenX, y = e.screenY, d = _.window.getComputedStyle ? _.window.getComputedStyle(c, null).getPropertyValue("cursor") : c.runtimeStyle.cursor, m = ye("<div></div>").css({
                ...
                opacity: 1e-4,
                cursor: d
            }).appendTo(x.body), ye(x).on("mousemove touchmove", v).on("mouseup touchend", p), h.start(e)
        }, v = function(e) {
    ...
    function _t(r) {
        ...
        function t(e, t) {
            for (var n, i = 0; i < bt.length; i++)
                if (bt[i] !== r)
                    for (n = bt[i].parent(); n && (n = n.parent());) n === r && bt[i].fixed(e).moveBy(0, t).repaint()
        }
    ...
    function Rt(e, t) {
        var n, i, r = Ct.zIndex || 65535;
        if (e) yt.push(t);
        else
            for (n = yt.length; n--;) yt[n] === t && yt.splice(n, 1);
        if (yt.length)
            for (n = 0; n < yt.length; n++) yt[n].modal && (r++, i = yt[n]), yt[n].getEl().style.zIndex = r, yt[n].zIndex = r, r++;
    ...
    var Ct = pt.extend({
        ...
        init: function(e) {
            ...
            }(), bt.push(i)), e.autofix && (ft || (ft = function() {
                var e;
    ...
    function Lt(e) {
        var t, n = ye("meta[name=viewport]")[0];
    ...
    var It = Ct.extend({
        ...
        fullscreen: function(e) {
            var n, t, i = this,
                ...
                o = i.classPrefix;
            if (e !== i._fullscreen)
                if (ye(_.window).on("resize", function() {
                        var e;
                        if (i._fullscreen)
    ...
    var Ft, Ut, Vt, Yt = It.extend({
        ...
        Un = function(e) {
            var t, n, i, r, o, s, a, l, u, c, d, f = Fn.browsers(),
                h = Fn.oses(),
        ...
        hi = function(e, i, r, t) {
            var n, o, s, a, l, u, c = {
                ...
                f = function(t) {
                    var e, n = Z(i, function(e) {
                        return e.type === t
                    });
                    return e = n, w.map(e, ci)
                };
            return !1 === t.typeahead_urls ? [] : "file" === r ? (n = [mi(e, d(ui)), mi(e, f("header")), mi(e, (a = f("anchor"), l = fi(t, "anchor_top", "#top"), u = fi(t, "anchor_bottom", "#bottom"), null !== l && a.unshift(di("<top>", l)), null !== u && a.push(di("<bottom>", u)), a))], o = function(e, t) {
