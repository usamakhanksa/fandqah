! function(l) {
    ...
    var i, e = tinymce.util.Tools.resolve("tinymce.PluginManager"),
        ...
        y = function(e, t) {
            return function(e, t) {
                for (var n = t !== undefined && null !== t ? t : b, r = 0; r < e.length && n !== undefined && null !== n; ++r) n = n[e[r]];
                return n
            }(e.split("."), t)
        },
        x = {
        ...
        ke = function(o) {
            return function(e) {
                for (var t, n, r = e.length, a = function(e) {
                    ...
                    }; r--;) t = e[r], (n = t.attr("class")) && /\bimage\b/.test(n) && (t.attr("contenteditable", o ? "false" : null), C.each(t.getAll("figcaption"), a))
            }
        },
        Me = function(e) {
